...
<?php
  function CheckForClickbait()
  {
    ...
    */
    ...
    $a = array("scientists","doctors","hate","stupid","weird","simple","trick",
    ...
    */
    $b = array("so-called scientists","so-called doctors","aren't threatened by",
                "average","completely normal","ineffective","method","is no different than the others",
